...
import (
	...
	maddr "github.com/kwokhunglee/micro/util/addr"
	mnet "github.com/kwokhunglee/micro/util/net"
	mls "github.com/kwokhunglee/micro/util/tls"

	"google.golang.org/grpc"
	"google.golang.org/grpc/credentials"

	pb "github.com/kwokhunglee/micro/transport/grpc/proto"
)
...
func init() {
	transport.DefaultTransportKey = "grpc"
	transport.DefaultTransports["grpc"] = NewTransport
	transport.InitDefaultTransport()
}
