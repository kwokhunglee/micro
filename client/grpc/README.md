...
The grpc client is a [micro.Client](https://godoc.org/github.com/kwokhunglee/micro/client#Client) compatible client.
...
import (
	...
	"github.com/kwokhunglee/micro/go-plugins/client/grpc"
)
