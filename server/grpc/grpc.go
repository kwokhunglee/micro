...
import (
	...
	"github.com/kwokhunglee/micro/errors"
	meta "github.com/kwokhunglee/micro/metadata"
	"github.com/kwokhunglee/micro/registry"
	"github.com/kwokhunglee/micro/server"
	"github.com/kwokhunglee/micro/util/addr"
	mgrpc "github.com/kwokhunglee/micro/util/grpc"
...
func init() {
	...
	server.DefaultServerKey = "grpc"
	server.DefaultServers["grpc"] = NewServer
	server.InitDefaultServer()
}
