...
The grpc server is a [micro.Server](https://godoc.org/github.com/kwokhunglee/micro/server#Server) compatible server.
...
import (
        ...
        "github.com/kwokhunglee/micro/go-plugins/server/grpc"
)
