...
var (
	...
	DefaultRouter        Router //= newRpcRouter() todo
	DefaultRegisterCheck = func(context.Context) error { return nil }
	DefaultServerKey     = ""
	DefaultServers       = map[string]func(...Option) Server{}
)
...
func NewServer(opts ...Option) Server {
	if v, ok := DefaultServers[DefaultServerKey]; ok {
		return v(opts...)
	}
	panic("DefaultServerKey is nil")
}
